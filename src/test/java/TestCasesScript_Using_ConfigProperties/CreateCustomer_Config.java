...
public class CreateCustomer_Config extends TestSetup{
	...
	@Test (priority=1 , enabled = true, groups = "customer" )
	...
	@Test (priority=3, enabled = true, groups = "customer")
	...
	@Test(priority =4, enabled = true, groups = "customer")
	...
	@Test(priority =5, enabled = true, groups = "customer")
